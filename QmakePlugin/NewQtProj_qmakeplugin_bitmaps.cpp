...
void wxCrafterM0lZAnInitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/NewQtProj_qmakeplugin_bitmaps.cpp$_mnt_SanDisk128-common_david_devel_git_CL_QmakePlugin_NewQtProj_qmakeplugin_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/NewQtProj_qmakeplugin_bitmaps.cpp$_mnt_SanDisk128-common_david_devel_git_CL_QmakePlugin_NewQtProj_qmakeplugin_bitmaps.xrc"));
}
