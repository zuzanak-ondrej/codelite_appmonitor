...
OpenTypeVListCtrl::OpenTypeVListCtrl(wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style)
...
wxListItemAttr* OpenTypeVListCtrl::OnGetItemAttr(long item) const
{
	return NULL;
}
