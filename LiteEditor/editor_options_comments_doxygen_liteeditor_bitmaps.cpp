...
void wxCB83BInitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/editor_options_comments_doxygen_liteeditor_bitmaps.cpp$_home_eran_devl_codelite_LiteEditor_editor_options_comments_doxygen_liteeditor_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/editor_options_comments_doxygen_liteeditor_bitmaps.cpp$_home_eran_devl_codelite_LiteEditor_editor_options_comments_doxygen_liteeditor_bitmaps.xrc"));
}
