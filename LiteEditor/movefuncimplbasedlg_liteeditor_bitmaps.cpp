...
void wxCrafterRzeI25InitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/movefuncimplbasedlg_liteeditor_bitmaps.cpp$_home_eran_devl_codelite_LiteEditor_movefuncimplbasedlg_liteeditor_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/movefuncimplbasedlg_liteeditor_bitmaps.cpp$_home_eran_devl_codelite_LiteEditor_movefuncimplbasedlg_liteeditor_bitmaps.xrc"));
}
