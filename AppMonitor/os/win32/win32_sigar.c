...
static int get_proc_info(sigar_t *sigar, sigar_pid_t pid); // added for CodeLite-AppMonitor (win10)
/*
                                ...
                                int multi)
{
    while (*ptr) {
        ...
        // klen = val - ptr;
        klen = ((unsigned char*)val) - ptr; // changed for CodeLite-AppMonitor (win10)
    ...
    *ipaddr = NULL;
    ...
    if (sigar->netif_addr_rows) {
        ...
        for (i=0; i<mib->dwNumEntries; i++) {
            ...
            short type;
// commented for CodeLite-AppMonitor (win10)
...
static int netif_hash(char *s); // added for CodeLite-AppMonitor (win10)
