...
#define EPOCH_DELTA 11644473600000000 // changed for CodeLite-AppMonitor (win10)
...
//typedef struct { // commented for CodeLite-AppMonitor (win10)
//    DWORD dwLength;
//    DWORD dwMemoryLoad;
...
//typedef struct _SERVICE_STATUS_PROCESS { // commented for CodeLite-AppMonitor (win10)
//    DWORD dwServiceType;
...
//typedef enum { // commented for CodeLite-AppMonitor (win10)
...
// changed for CodeLite-AppMonitor (win10)
