    ...
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    ID_PANEL = new wxPanel(ID_NOTEBOOK1, wxID_ANY, wxDefaultPosition, wxSize(-1, -1), wxTAB_TRAVERSAL);
    ...
    bSizer2->Add(sbSizer02, 0, wxALL|wxEXPAND, 5);
    ...
    sbSizer02->Add(fgSizer2, 0, wxALL|wxEXPAND, 5);
    
    m_static3 = new wxStaticText(ID_PANEL, wxID_ANY, _(".h filename:"), wxDefaultPosition, wxSize(-1, -1), 0);
    ...
    m_static4 = new wxStaticText(ID_PANEL, wxID_ANY, _(".cpp filename:"), wxDefaultPosition, wxSize(-1, -1), 0);
    ...
    m_staticProjectTreeFolder = new wxStaticText(ID_PANEL, wxID_ANY, _("Project tree folder:"), wxDefaultPosition, wxSize(-1, -1), 0);
    m_staticProjectTreeFolder->SetForegroundColour(wxColour(wxT("rgb(255,0,0)")));
    
    fgSizer2->Add(m_staticProjectTreeFolder, 0, wxALL|wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL, 5);
    
    m_textCtrlVD = new wxTextCtrl(ID_PANEL, wxID_ANY, wxT(""), wxDefaultPosition, wxSize(230,-1), wxTE_READONLY);
    m_textCtrlVD->SetToolTip(_("Virtual folder to add new files"));
    #if wxVERSION_NUMBER >= 3000
    m_textCtrlVD->SetHint(wxT(""));
    #endif
    
    fgSizer2->Add(m_textCtrlVD, 0, wxALL|wxEXPAND|wxALIGN_CENTER_VERTICAL, 5);
    
    m_buttonBrowseVD = new wxButton(ID_PANEL, wxID_ANY, _("..."), wxDefaultPosition, wxSize(-1, -1), 0);
    m_buttonBrowseVD->SetToolTip(_("Browse virtual folders"));
    
    fgSizer2->Add(m_buttonBrowseVD, 0, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    
    m_static5 = new wxStaticText(ID_PANEL, wxID_ANY, _("Path:"), wxDefaultPosition, wxSize(-1, -1), 0);
    
    fgSizer2->Add(m_static5, 0, wxALL|wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL, 5);
    
    m_textCtrlFilePath = new wxTextCtrl(ID_PANEL, wxID_ANY, wxT(""), wxDefaultPosition, wxSize(230,-1), wxTE_READONLY);
    m_textCtrlFilePath->SetToolTip(_("Hd folder to add new files"));
    #if wxVERSION_NUMBER >= 3000
    m_textCtrlFilePath->SetHint(wxT(""));
    #endif
    
    fgSizer2->Add(m_textCtrlFilePath, 0, wxALL|wxEXPAND|wxALIGN_CENTER_VERTICAL, 5);
    
    m_buttonBrowsePath = new wxButton(ID_PANEL, wxID_ANY, _("..."), wxDefaultPosition, wxSize(-1, -1), 0);
    m_buttonBrowsePath->SetToolTip(_("Browse  folders"));
    
    fgSizer2->Add(m_buttonBrowsePath, 0, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    
    bSizer2->Add(0, 0, 1, wxALL, 5);
    
    wxBoxSizer* bSizer3 = new wxBoxSizer(wxHORIZONTAL);
    
    bSizer2->Add(bSizer3, 0, wxALL|wxALIGN_CENTER_HORIZONTAL, 5);
    
    m_buttonGenerate = new wxButton(ID_PANEL, wxID_OK, _("&Generate"), wxDefaultPosition, wxSize(-1, -1), 0);
    m_buttonGenerate->SetDefault();
    m_buttonGenerate->Enable(false);
    
    bSizer3->Add(m_buttonGenerate, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5);
    
    m_buttonCancel = new wxButton(ID_PANEL, wxID_CANCEL, _("&Quit"), wxDefaultPosition, wxSize(-1, -1), 0);
    
    bSizer3->Add(m_buttonCancel, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5);
    
    ID_PANEL1 = new wxPanel(ID_NOTEBOOK1, wxID_ANY, wxDefaultPosition, wxSize(-1, -1), wxTAB_TRAVERSAL);
    ...
    bSizer4->Add(bSizer5, 0, wxALL|wxEXPAND, 1);
    
    m_static6 = new wxStaticText(ID_PANEL1, wxID_ANY, _("Class:"), wxDefaultPosition, wxSize(-1, -1), 0);
    
    bSizer5->Add(m_static6, 0, wxALL|wxALIGN_CENTER_VERTICAL, 1);
    
    wxArrayString m_comboxTemplatesArr;
    m_comboxTemplates = new wxComboBox(ID_PANEL1, wxID_ANY, wxT(""), wxDefaultPosition, wxSize(-1, -1), m_comboxTemplatesArr, wxCB_SORT);
    #if wxVERSION_NUMBER >= 3000
    m_comboxTemplates->SetHint(wxT(""));
    #endif
    
    bSizer5->Add(m_comboxTemplates, 1, wxALL|wxALIGN_CENTER_VERTICAL, 1);
    
    m_buttonAddTemplate = new wxButton(ID_PANEL1, wxID_ANY, _("Add"), wxDefaultPosition, wxSize(-1, -1), 0);
    m_buttonAddTemplate->SetDefault();
    
    bSizer5->Add(m_buttonAddTemplate, 0, wxALL|wxALIGN_CENTER_VERTICAL, 1);
    
    m_buttonChangeTemplate = new wxButton(ID_PANEL1, wxID_ANY, _("Change"), wxDefaultPosition, wxSize(-1, -1), 0);
    
    bSizer5->Add(m_buttonChangeTemplate, 0, wxALL|wxALIGN_CENTER_VERTICAL, 1);
    
    m_buttonRemoveTemplate = new wxButton(ID_PANEL1, wxID_ANY, _("Remove"), wxDefaultPosition, wxSize(-1, -1), 0);
    
    bSizer5->Add(m_buttonRemoveTemplate, 0, wxALL|wxALIGN_CENTER_VERTICAL, 1);
    
    m_buttonClear = new wxButton(ID_PANEL1, wxID_ANY, _("Clear"), wxDefaultPosition, wxSize(-1, -1), 0);
    
    bSizer5->Add(m_buttonClear, 0, wxALL|wxALIGN_CENTER_VERTICAL, 1);
    
    m_buttonInsertClassMacro = new wxButton(ID_PANEL1, wxID_ANY, _("%CLASS%"), wxDefaultPosition, wxSize(-1, -1), 0);
    
    bSizer5->Add(m_buttonInsertClassMacro, 0, wxALL|wxALIGN_CENTER_VERTICAL, 1);
    
    m_notebookFiles = new wxNotebook(ID_PANEL1, wxID_ANY, wxDefaultPosition, wxSize(500,-1), wxBK_TOP|wxBK_DEFAULT);
    m_notebookFiles->SetName(wxT("m_notebookFiles"));
    
    bSizer4->Add(m_notebookFiles, 1, wxALL|wxEXPAND, 1);
    
    m_panel3 = new wxPanel(m_notebookFiles, wxID_ANY, wxDefaultPosition, wxSize(-1, -1), wxTAB_TRAVERSAL);
    m_notebookFiles->AddPage(m_panel3, _("Header File"), true);
    
    wxBoxSizer* bSizer6 = new wxBoxSizer(wxVERTICAL);
    m_panel3->SetSizer(bSizer6);
    
    m_textCtrlHeader = new wxStyledTextCtrl(m_panel3, wxID_ANY, wxDefaultPosition, wxSize(-1,-1), 0);
    ...
    m_panel4 = new wxPanel(m_notebookFiles, wxID_ANY, wxDefaultPosition, wxSize(-1, -1), wxTAB_TRAVERSAL);
    ...
    m_textCtrlImpl = new wxStyledTextCtrl(m_panel4, wxID_ANY, wxDefaultPosition, wxSize(-1,-1), 0);
    // Configure the fold margin
