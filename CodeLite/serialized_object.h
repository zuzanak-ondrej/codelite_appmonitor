...
public:
	...
	virtual const wxString& GetVersion() const {
		return m_version;
	}
};
...
public:
	...
	void SetFirstVisibleLine(const int& _firstVisibleLine) {
		this->m_firstVisibleLine = _firstVisibleLine;
	}
	void SetCurrentLine(const int& _currentLine) {
		this->m_currentLine = _currentLine;
	}
	...
	const int& GetFirstVisibleLine() const {
		return this->m_firstVisibleLine;
	}
