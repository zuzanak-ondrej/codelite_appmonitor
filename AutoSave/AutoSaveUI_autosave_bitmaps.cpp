...
void wxCrafter7A2fyVInitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/AutoSaveUI_autosave_bitmaps.cpp$_home_eran_devl_codelite_AutoSave_AutoSaveUI_autosave_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/AutoSaveUI_autosave_bitmaps.cpp$_home_eran_devl_codelite_AutoSave_AutoSaveUI_autosave_bitmaps.xrc"));
}
