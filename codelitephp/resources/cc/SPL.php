...
interface Countable  {
	 ...
	 *       The optional mode parameter will be set to
	 *       COUNT_NORMAL or COUNT_RECURSIVE, depending 
	 *       on what value was passed to the second parameter of count.
	 ...
	 */
	abstract public function count ($mode = null) ;
...
class SplFileObject extends SplFileInfo implements RecursiveIterator, Traversable, Iterator, SeekableIterator {
	 ...
	 *     </p>
	 * @return string the string read from the file &return.falseforfailure;.
	 */
