...
function page_cache_remove_cached_contents_by_uri () {}

function page_cache_remove_cached_contents_by_rule () {}

function page_cache_remove_cached_contents_by_rules_ids () {}
