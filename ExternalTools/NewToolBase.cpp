    ...
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    m_staticText5 = new wxStaticText(this, wxID_ANY, _("Tool ID:"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    ...
    m_staticText6 = new wxStaticText(this, wxID_ANY, _("Name:"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    ...
    m_staticText1 = new wxStaticText(this, wxID_ANY, _("Tool path:"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    ...
    m_buttonBrowsePath = new wxButton(this, wxID_ANY, _("..."), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), wxBU_EXACTFIT);
    
    fgSizer1->Add(m_buttonBrowsePath, 0, wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));
    
    m_staticText2 = new wxStaticText(this, wxID_ANY, _("Working directory:"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    ...
    m_buttonBrowseWd = new wxButton(this, wxID_ANY, _("..."), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), wxBU_EXACTFIT);
    
    fgSizer1->Add(m_buttonBrowseWd, 0, wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));
    
    m_staticText3 = new wxStaticText(this, wxID_ANY, _("Arguments:"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    
    fgSizer1->Add(m_staticText3, 0, wxALL|wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));
    
    m_textCtrlArguments = new wxTextCtrl(this, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    m_textCtrlArguments->SetToolTip(_("Set a list of arguments to pass to the tool"));
    #if wxVERSION_NUMBER >= 3000
    m_textCtrlArguments->SetHint(wxT(""));
    #endif
    
    fgSizer1->Add(m_textCtrlArguments, 1, wxALL|wxEXPAND|wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));
    ...
    m_staticText8 = new wxStaticText(this, wxID_ANY, _("Toolbar icon (24x24):"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    ...
    m_buttonBrowseIcon24 = new wxButton(this, wxID_ANY, _("Browse..."), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    
    fgSizer2->Add(m_buttonBrowseIcon24, 0, wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));
    
    m_staticText7 = new wxStaticText(this, wxID_ANY, _("Toolbar icon (16x16):"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    ...
    m_buttonBrowseIcon16 = new wxButton(this, wxID_ANY, _("Browse..."), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    ...
    m_checkBoxSaveAllFilesBefore = new wxCheckBox(this, wxID_ANY, _("Save all files before executing this tool"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    ...
    m_checkBoxCaptureOutput = new wxCheckBox(this, wxID_ANY, _("Capture process output"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1,-1)), 0);
    m_checkBoxCaptureOutput->SetValue(false);
    
    sbSizer2->Add(m_checkBoxCaptureOutput, 0, wxALL, WXC_FROM_DIP(5));
    
    m_checkBoxCallOnFileSave = new wxCheckBox(this, wxID_ANY, _("Run this tool when a file is saved"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1,-1)), 0);
    m_checkBoxCallOnFileSave->SetValue(false);
    m_checkBoxCallOnFileSave->SetToolTip(_("Whenever a file is being saved, this tool is called with\nthe file's fullpath as the first input argument."));
